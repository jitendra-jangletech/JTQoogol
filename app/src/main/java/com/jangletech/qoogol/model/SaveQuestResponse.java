 ...
 */
public class SaveQuestResponse {
    ...
    private List<LearningQuestions> question_list;
    ...
    public List<LearningQuestions> getQuestion_list() {
        return question_list;
    }

    public void setQuestion_list(List<LearningQuestions> question_list) {
