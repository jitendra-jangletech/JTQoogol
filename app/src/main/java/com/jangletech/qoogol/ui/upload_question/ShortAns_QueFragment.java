 ...
 */
public class ShortAns_QueFragment extends Fragment implements AnsScanDialog.AnsScannerListener {
    ...
    private void addQuestion() {
        if (isValidate()) {
            ...
            Call<ResponseObj> call= apiService.addSubjectiveQuestionsApi(user_id, qoogol, getDeviceId(),
                    ...
                    mBinding.questiondescEdittext.getText().toString(),SHORT_ANSWER,mBinding.edtmarks.getText().toString(),
                    mBinding.edtduration.getText().toString(),getSelectedDiffLevel(),mBinding.answerEdittext.getText().toString());
