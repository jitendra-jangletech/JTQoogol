...
public class FillBlanksFragment extends BaseFragment implements QuestReportDialog.QuestReportDialogListener{
    private static final String ARG_COUNT = "param1";
    private Integer counter;
    private FillInTheBlanksLayoutBinding mBinding;
    private QuestReportDialog questReportDialog;

    public static FillBlanksFragment newInstance(Integer counter) {
        FillBlanksFragment fragment = new FillBlanksFragment();
