...
import com.jangletech.qoogol.databinding.FragmentQuestionAnalyticsBinding;
...
public class QuestionAnalyticsFragment extends BaseFragment {

    private static final String TAG = "QuestionAnalyticsFragme";
    private FragmentQuestionAnalyticsBinding mBinding;
    private DashBoard dashBoard;
    private ArrayList<TestAnalytics> testAnalytics = new ArrayList<>();

    public QuestionAnalyticsFragment(DashBoard dashBoard) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_question_analytics, container, false);
