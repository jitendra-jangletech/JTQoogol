...
public class ShortAnsFragment extends BaseFragment implements QuestReportDialog.QuestReportDialogListener{
    private static final String ARG_COUNT = "param1";
    private Integer counter;
    private MultiLineQuestAnsBinding mBinding;
    private QuestReportDialog questReportDialog;

    public static ShortAnsFragment newInstance(Integer counter) {
        ShortAnsFragment fragment = new ShortAnsFragment();
