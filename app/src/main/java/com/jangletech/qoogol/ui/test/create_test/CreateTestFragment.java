package com.jangletech.qoogol.ui.test.create_test;
...
public class CreateTestFragment extends Fragment {
    ...
    public static CreateTestFragment newInstance() {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(CreateTestViewModel.class);
