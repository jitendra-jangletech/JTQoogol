...
public class MyQuestionsFragment extends BaseFragment implements MyQuestionsAdapter.ItemClickListener {
    ...
    private void getData() {
        Call<LearningQuestResponse>  call = apiService.fetchMyQuestionsApi(mSettings.getUserId(), getDeviceId(getActivity()), qoogol, mSettings.getString(Constant.ue_id),String.valueOf(pageCount));
