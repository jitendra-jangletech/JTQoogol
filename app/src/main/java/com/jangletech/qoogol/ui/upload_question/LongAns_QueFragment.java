 ...
 */
public class LongAns_QueFragment extends Fragment implements AnsScanDialog.AnsScannerListener {
    ...
    private void addQuestion() {
        if (isValidate()) {
            ...
            Call<ResponseObj> call= apiService.addSubjectiveQuestionsApi(user_id, qoogol, getDeviceId(),
                    ...
                    mBinding.questiondescEdittext.getText().toString(),LONG_ANSWER,mBinding.edtmarks.getText().toString(),
