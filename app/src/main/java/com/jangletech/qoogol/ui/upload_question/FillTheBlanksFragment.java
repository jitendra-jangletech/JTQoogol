...
public class FillTheBlanksFragment extends BaseFragment  implements QueMediaListener {
    ...
    private void setData(LearningQuestionsNew learningQuestionsNew) {
        ...
        mBinding.etRightAns.setText(learningQuestionsNew.getAnswer());
                    ...
                    if (mAllUri.size() > 3) {
                        ...
                        try {
                            ...
                            CropImage.activity(imageUri)
                                    ...
                                    .start(getActivity(), FillTheBlanksFragment.this);
                        } catch (Exception e) {
