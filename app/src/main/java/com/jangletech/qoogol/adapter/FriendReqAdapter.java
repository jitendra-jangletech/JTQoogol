...
public class FriendReqAdapter extends RecyclerView.Adapter<FriendReqAdapter.ViewHolder> implements Filterable {
    ...
    @NonNull
    @Override
    public FriendReqAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (FriendRequest row : filteredConnectionsList) {
            ...
            protected void publishResults(CharSequence constraint, FilterResults filterResults) {
                connectionsList = (ArrayList<FriendRequest>) filterResults.values;
